...
from .views import (activate_email_view, change_password_view, dashboard_view,
                    edit_profile_view, forgot_password_view, login_view,
                    logout_view, my_orders_view, register_view,
